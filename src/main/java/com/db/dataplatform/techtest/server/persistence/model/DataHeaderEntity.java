...
@Entity
@Table(name = "DATA_HEADER", uniqueConstraints = @UniqueConstraint(columnNames = "NAME"))
@Setter
@Getter
public class DataHeaderEntity {
  ...
  @Id
  @SequenceGenerator(
      name = "dataHeaderSequenceGenerator",
      sequenceName = "SEQ_DATA_HEADER",
      allocationSize = 1)
  ...
  public boolean equals(Object o) {
    ...
    return dataHeaderId == dataHeaderEntity.dataHeaderId && (name.equals(dataHeaderEntity.name));
  }
}
