...
public class ServerImpl implements Server {
  ...
  private final DataHeaderServiceImpl dataHeaderServiceImpl;
  ...
  @Override
  public Optional<DataHeaderEntity> getByBlockName(String blockName) {
    return dataHeaderServiceImpl.getDataByBlockName(blockName);
  }
  ...
  private void persist(DataEnvelope envelope) {
    ...
    DataHeaderEntity dataHeaderEntity =
        modelMapper.map(envelope.getDataHeader(), DataHeaderEntity.class);
