...
public class ServerControllerComponentTest {
  ...
  public static final UriTemplate URI_GETDATA =
      new UriTemplate("http://localhost:8090/dataserver/data/{blockType}");
  public static final UriTemplate URI_PATCHDATA =
      new UriTemplate("http://localhost:8090/dataserver/update/{name}/{newBlockType}");
  ...
  public void testGetDataCallNotContentWorksAsExpected() throws Exception {
    ResultActions resultActions =
        mockMvc
            .perform(get(URI_GETDATA.toString(), BlockTypeEnum.BLOCKTYPEA.getTypeName()))
            .andExpect(status().isOk())
            .andDo(print());
  ...
  public void testPatchDataCallWorksAsExpected() throws Exception {
    ...
    ResultActions resultActions =
        mockMvc
            .perform(
                patch(URI_PATCHDATA.toString(), TEST_NAME, BlockTypeEnum.BLOCKTYPEB.getTypeName()))
